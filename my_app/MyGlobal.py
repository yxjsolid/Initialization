...
WINDOW_TITLE_EDIT_IO_NODE = u"编辑数据点"
WINDOW_TITLE_SELECT_IO_NODE = u"选择数据点"
...
WINDOW_TITLE_EDIT_IO_STATION = u"编辑I/O站点"
...
WINDOW_TITLE_ACTION_EDIT_GROUP = u"编辑动作脚本"
