...
:param panel:
"""
        b = buttons.GenButton(panel, -1, pos = (500,200),name='Genric Button')#���ͨ�ð�ť
       
        b = buttons.GenButton(panel, -1,  label='disabled Generic',pos = (500,290),name='disabled Generic')#��Ч��ͨ�ð�ť  
        #b.Enable(False)  
          
        """
        b = buttons.GenButton(panel, -1,  pos = (500,400),name='bigger')#�Զ���ߴ����ɫ�İ�ť  
        ...
        self.testBtn =  MyGenBitmapButton(panel, -1,  pos = (470,300), style =   wx.BORDER_NONE|wx.TRANSPARENT_WINDOW)#ͨ��λͼ��ť  
        ...
        self.testBtn1 =  MyGenBitmapToggleButton(panel, -1,  pos = (520,300), style =   wx.BORDER_NONE|wx.TRANSPARENT_WINDOW)#ͨ��λͼ��ť  
        ...
        self.testBtn2 =  MyGenBitmapToggleButton(panel, -1,  pos = (520,300), style =   wx.BORDER_NONE|wx.TRANSPARENT_WINDOW)#ͨ��λͼ��ť  
        ...
        self.testBtn3 =  MyGenBitmapToggleButton(panel, -1,  pos = (520,300), style =   wx.BORDER_NONE|wx.TRANSPARENT_WINDOW)#ͨ��λͼ��ť  
       ...
       # b.SetBackgroundColour((255,0,0,0)) 
        ...
        #b = sbbutton.SBitmapButton(panel, -1, pos = (500,400),bitmap=bmp)#ͨ��λͼ���ذ�ť  
        
        #bitmap = wx.BitmapFromImage(image)


       # b = buttons.GenBitmapTextButton(panel, -1, pos = (500,700),bitmap=bmp, name="Bitmapped Text",size=(175, 75))#λͼ�ı���ť  
